      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 gap-x-10">
          <p>
            ...
            to create a fun and lively experience for guests. This included
            mostly signages and a claw machine.
          </p>
          <p>
            The campaign turned ice cream and wine samplings into sales, while
            the signage guided passengers with clear event and sampling details.{" "}
          </p>
        </div>
      </section>
    </>
