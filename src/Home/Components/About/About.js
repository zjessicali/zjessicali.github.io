    ...
    <div className=" w-full border-t-2 border-porple bg-white">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-0 md:border-r-2 border-r-white">
        ...
        <div className="border-b-2 border-r-2 border-porple w-full aspect-square flex flex-col justify-end">
          ...
          <p className="md:hidden font-Manrope text-sm m-5 mb-1 ">
            SFU's (2019 - present):
          </p>
          <p className="font-Manrope mx-5 mb-2 leading-tight md:text-lg lg:text-2xl md:mx-4 font-medium md:leading-none">
            School of Computing Science
          </p>
          <p className="font-Manrope leading-tight md:text-lg lg:text-2xl m-5 mt-0 md:m-4 md:mt-2 font-medium md:leading-none">
            School of Interactive Arts and Technology
          </p>
        </div>
        <div className="border-b-2 border-r-2 border-porple w-full hidden md:block"></div>
        <div className="border-b-2  border-b-porple border-r-2 border-white md:border-r-2 md:border-porple w-full aspect-square flex flex-col justify-end">
          <p className="font-Manrope mx-5 md:text-lg lg:text-2xl md:mx-4 font-medium md:leading-none">
            user experience
          </p>
          <p className="font-Manrope mx-5 md:text-lg lg:text-2xl md:mx-4 md:mt-2 font-medium md:leading-none">
            ui/visual design
          </p>
          <p className="font-Manrope mx-5 md:text-lg lg:text-2xl md:mx-4 md:mt-2 font-medium md:leading-none">
            interaction design
          </p>
          <p className="font-Manrope md:text-lg lg:text-2xl m-5 mt-0 md:m-4 md:mt-2 font-medium md:leading-none">
            prototyping
          </p>
        </div>
        <div className="border-b-2  border-porple w-full hidden md:block"></div>
        <div className="border-b-2 border-r-2 border-porple w-full hidden md:block"></div>
        <div
          className="border-b-2 border-r-2 border-porple w-full aspect-square flex flex-col justify-end"
